...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Grand@123".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rust.letsgrand.com"];
pub const RS_PUB_KEY: &str = "Pyv+oH+6wEFeYcnFR93LbCHHTT5EQspxllRQjVVKHJA=";
